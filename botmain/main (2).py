...
bot = telebot.TeleBot('5719000911:AAFM27N3riN9hEmA2lROqQlFMBW-6BMIZ1g')
...
#         вызов функции очистить корзину
...
def get_accept(message, address, full_text):
    ...
    if type_yes == 'Подтвердить':
        ...
        bot.send_message(599956283,full_text.replace('Ваш', 'Новый'))
        bot.delete_message(user_id, message_id)
